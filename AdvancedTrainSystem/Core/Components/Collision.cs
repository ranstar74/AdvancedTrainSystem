using AdvancedTrainSystem.Core.Components.Utils;
...
{
    /// <summary>Handles collision detection between trains.</summary>
    public class Collision : TrainComponent
    {
        /// <summary>
        ...
        public Collision(ComponentCollection components) : base(components)
        {
