...
{
    public class SteamParticles : Particles
    {
        ...
        private Derail _derail;

        private Prop _fireboxDummyProp;

        public SteamParticles(ComponentCollection components) : base(components)
        {
        ...
        public override void Start()
        {
            ...
            _dynamo = Components.GetComponent<Dynamo>();
            _safetyValve = Components.GetComponent<SafetyValve>();
            _chimney = Components.GetComponent<Chimney>();
            _derail = Components.GetComponent<Derail>();
